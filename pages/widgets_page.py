...
class AutoCompletePage(BasePage):
    ...
    def remove_value_from_multi(self):
        ...
        remove_button_list = self.element_are_all_visible(self.locators.MULTI_VALUE_REMOVE)
...
class DatePickerPage(BasePage):
    ...
    # "Methods should be moved to the base_page.py"
...
class ToolTipsPage(BasePage):
    ...
    def check_tool_tips(self):
        ...
        tool_tip_text_contrary = self.get_text_from_tool_tips(self.locators.CONTRARY, self.locators.TOOL_TIP_CONTRARY)
        tool_tip_text_section = self.get_text_from_tool_tips(self.locators.SECTION_LINK, self.locators.TOOL_TIP_LINK)
...
class MenuPage(BasePage):
    ...
    def check_menu(self):
        menu_item_list = self.element_are_presents(self.locators.MENU_ITEM_LIST)
        data = []
...
class SelectMenuPage(BasePage):
    ...
    @allure.step("check select menu item")
